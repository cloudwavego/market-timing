...
symbol = 'BTC-USDT'  # 指定币种
# para = [8, 0.03]  # 策略参数
para = [580, 2.5, 20] # 策略参数
proportion = 0.05  # 止盈止损比例
rule_type = '1H'  # 周期
rule_types = ['1H']  # 周期
date_start = '2021-04-01'  # 回测开始时间
date_end = '2026-07-19'  # 回测结束时间
...
signal_name = 'signal_bolling_rsi'  # 策略名称
strategies = ['signal_bolling_rsi']
...
symbol_list = ['ETH-USDT', 'BTC-USDT', 'SOL-USDT', 'BNB-USDT'] 
